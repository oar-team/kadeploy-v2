...
\subsection{Kanodes}
Kastat is designed to show the state of the nodes.
...
> kanodes
\end{verbatim}
This commands prints the state of all the nodes managed by a Kadeploy server.

\paragraph{Use case 2}
\begin{verbatim}
> kanodes -m gdx-25.orsay.grid5000.fr -f machine_file
\end{verbatim}
This command prints the state of the node \textit{gdx-25.orsay.grid5000.fr} and of the nodes listed in the file \texttt{machine\_file}.
