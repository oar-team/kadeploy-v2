...
##BEGIN $kadeploy_tag 
Defaults>deploy          env_reset,env_keep = "PWD PERL5LIB DISPLAY"
Cmnd_Alias DEPLOYCMDUSER = $bindir/kaconsole, $bindir/kadeploy, $bindir/kaenvironments, $bindir/kareboot, $bindir/karecordenv, $bindir/migratenv,$sbindir/setup_pxe.pl,$bindir/karemote 
