...
B<kadeploy>  B<-e|--environment> environment_name [B<-l> username] [B<-d|--device> device] [B<-p|--partition> partition] [B<-m|--machine> hostname] [B<-f> nodefile] [B<-dl|--debug-level> debug_level] [B<-u|--use-prod-env>] [B<-r|--reformat-tmp>] [B<-fkr|--fast-kernel-reboot>] [B<-s|--script> path_to_script]
...
=item B<-dl|--debug-level> debug_level
